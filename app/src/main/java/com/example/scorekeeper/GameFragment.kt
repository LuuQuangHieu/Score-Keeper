...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //Get data pass from previous frame
        val args = GameFragmentArgs.fromBundle(requireArguments())
        binding.gameFragmentTeam1Name.text = args.team1Name
        binding.gameFragmentTeam2Name.text = args.team2Name
        ...
        binding.button10.setOnClickListener{nextFragment()} //button10 is end button
    ...
    private fun team1Shoot(pointValue: Int){
        ...
        val shootingPercentages = round(team1MadeShots.toFloat()/team1TotalShots * 10000)/100
        binding.gaemFragmentTvTeam1Percentage.text = "$shootingPercentages %"
    }
    ...
    private fun team2Shoot(pointValue: Int){
        if(pointValue != 0){
            ...
            when{
                binding.gameFragmentRbQ1.isChecked -> {
                    val quarterScore = binding.gameFragmentTeam2Q1.text.toString().toInt() + pointValue
                    binding.gameFragmentTeam2Q1.text = quarterScore.toString()
                }
                binding.gameFragmentRbQ2.isChecked-> {
        ...
        val shootingPercentages = round(team2MadeShots.toFloat()/team2TotalShots * 10000)/100
        binding.gameFragmentTvTeam2Percentage.text = "$shootingPercentages %"
    }

    //Move to the next fragment
    private fun nextFragment(){
        val team1 = binding.gameFragmentTeam1Name.text.toString()
        val score1 = binding.gameFragmentTvTeam1Score.text.toString()

        val team2 = binding.gameFragmentTeam2Name.text.toString()
